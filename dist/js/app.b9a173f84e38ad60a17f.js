...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _services_data__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./services/data */ \"./src/js/modules/services/data.js\");\n\n\nvar addToBasket = function addToBasket() {\n  var cardAddCart = document.querySelectorAll('.card-add-cart'),\n      cartWrapper = document.querySelector('.cart-wrapper'),\n      cartEmpty = document.getElementById('cart-empty'),\n      cartTotal = document.querySelector('.cart-total span'),\n      cartCounter = document.querySelector('#cart span');\n  var buysArray = [];\n  var counter = 0;\n\n  var detectBuys = function detectBuys() {\n    if (cartWrapper.children.length > 1) {\n      cartEmpty.style.display = 'none';\n    } else {\n      cartEmpty.style.display = 'flex';\n    }\n  };\n\n  var addBuys = function addBuys(e) {\n    var target = e.target;\n    Object(_services_data__WEBPACK_IMPORTED_MODULE_0__[\"getData\"])('db/db.json').then(function (responce) {\n      responce.forEach(function (item) {\n        if (target.dataset.id === item.id) {\n          var buysObj = {\n            price: +item.price,\n            title: item.title,\n            id: item.id\n          };\n          buysArray.push(buysObj);\n          cartTotal.textContent = buysArray.reduce(function (res, item) {\n            return item.price + res;\n          }, 0);\n          var div = document.createElement('div');\n          div.classList.add('goods');\n          div.innerHTML = \"\\n\\t\\t\\t\\t\\t\\t\\t\\t<div class=\\\"goods-img-wrapper\\\">\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t<img class=\\\"goods-img\\\" src=\".concat(item.imgMin, \" alt=\\\"\\\">\\n\\t\\t\\t\\t\\t\\t\\t\\t</div>\\n\\t\\t\\t\\t\\t\\t\\t\\t<div class=\\\"goods-description\\\">\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t<h2 class=\\\"goods-title\\\">\").concat(item.title, \"</h2>\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t<p class=\\\"goods-price\\\">\").concat(item.price, \" \\u20BD</p>\\n\\t\\t\\t\\t\\t\\t\\t\\t</div>\\n\\t\\t\\t\\t\\t\\t\\t\\t<div class=\\\"goods-price-count\\\">\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t<div class=\\\"goods-trigger\\\">\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t<button class=\\\"goods-add-wishlist\\\"></button>\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t<button class=\\\"goods-delete\\\"></button>\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t</div>\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t<div class=\\\"goods-count\\\">1</div>\\n\\t\\t\\t\\t\\t\\t\\t\\t</div>\\n\\t\\t\\t\\t\\t\\t\\t\");\n          cartWrapper.appendChild(div);\n          counter++;\n          cartCounter.textContent = counter;\n          detectBuys();\n        }\n      });\n    }).then(function () {\n      var goods = document.querySelectorAll('.goods');\n      goods.forEach(function (item, i) {\n        item.addEventListener('click', function (e) {\n          cartCounter.textContent = i;\n          var target = e.target;\n\n          if (target.classList.contains('goods-delete')) {\n            target.closest('.goods').remove();\n          }\n\n          detectBuys();\n        });\n      });\n    });\n  };\n\n  cardAddCart.forEach(function (item) {\n    return item.addEventListener('click', addBuys);\n  });\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (addToBasket);\n\n//# sourceURL=webpack:///./src/js/modules/addToBasket.js?");
...
/***/ "./src/js/modules/services/data.js":
/*!*****************************************!*\
  !*** ./src/js/modules/services/data.js ***!
  \*****************************************/
